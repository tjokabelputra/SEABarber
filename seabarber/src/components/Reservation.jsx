...
function Reservation() {
    ...
    return (
        <>
            ...
            >
                <div className="w-1/4 h-3/5 bg-white rounded-xl flex flex-col justify-center max-2xl:h-4/5 max-2xl:w-3/5 max-lg:h-3/5 max-lg:w-3/5 max-sm:w-11/12 max-sm:h-3/4">
                    <h1 className="pt-4 mb-2 px-8 text-3xl text-center max-sm:text-2xl">Reservation</h1>
                    <p className="px-4 text-xl text-center font-semibold max-sm:text-base max-sm:pb-2">Each Session 1 Hour</p>
                    <p className="px-4 mb-2 text-xl text-center font-semibold max-sm:text-base">{branchInfo.name}: {branchInfo.open} - {branchInfo.close}</p>
